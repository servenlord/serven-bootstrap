...
<body>
  <nav class="py-2 bg-body-tertiary border-bottom">
    <div class="container d-flex flex-wrap">
      ...
      <ul class="nav">
        <li class="nav-item"><a href="login.php" class="btn btn-outline-primary m-1">Masuk</a></li>
  ...
  <div class="container mt-3 py-5">
    ...
    <div class="row">
      ...
      if (isset($_GET['albumid'])) {
        ...
        $query = mysqli_query($con, "SELECT * FROM foto INNER JOIN album ON foto.AlbumID = album.AlbumID WHERE foto.AlbumID='$albumid'");
                      ...
                      <div class="col-md-4">
                        <div class="m-2">
                          <div class="overflow-auto">
                            ...
                            <?php
                            $fotoid = $data['FotoID'];
                            $komentar = mysqli_query($con, "SELECT * FROM komentarfoto INNER JOIN user ON komentarfoto.UserID = user.UserID");
