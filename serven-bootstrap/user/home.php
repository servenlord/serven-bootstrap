...
<body>
    <nav class="py-2 bg-body-tertiary border-bottom">
        <div class="container d-flex flex-wrap">
            <ul class="nav me-auto">
                ...
                <li class="nav-item"><a href="home.php" class="nav-link link-body-emphasis px-2 active" aria-current="page">Galeri Saya</a></li>
    ...
    <div class="container mt-3 py-5">
        Album:
        <?php
        $album = mysqli_query($con, "SELECT * FROM album WHERE UserID = $userid");
        ...
        <div class="row">
            ...
            if (isset($_GET['albumid'])) {
                ...
                $query = mysqli_query($con, "SELECT * FROM foto INNER JOIN user ON foto.UserID=user.UserID INNER JOIN album ON foto.AlbumID = album.AlbumID WHERE foto.UserID='$userid' AND foto.AlbumID='$albumid'");
                ...
                $query = mysqli_query($con, "SELECT * FROM foto INNER JOIN user ON foto.UserID=user.UserID INNER JOIN album ON foto.AlbumID = album.AlbumID WHERE foto.UserID='$userid'");
                while ($data = mysqli_fetch_array($query)) {
                ?>
                    <div class="col-md-3 mt-2">
                        <a data-bs-toggle="modal" data-bs-target="#komentar<?php echo $data['FotoID']; ?>">
